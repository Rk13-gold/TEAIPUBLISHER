...
# --- Emojis especiales que se animan en Telegram ---
ANIMATED_EMOJIS = {
    "🎭 Animados Premium": [
        "🎉","🎊","✨","🌟","💫","⭐","🔥","💥","💯","🎯","🚀","💎","👑","🏆","🥇","🔮",
        "🎭","🎪","🎨","🎵","🎶","🎤","🎸","🎹","🥳","😍","🤩","😎","�","�","💕","�",
    ...
    "⚡ Efectos de Telegram": [
        # Estos emojis tienen efectos especiales avanzados en Telegram
        "🎆","🎇","✨","💫","🌟","⭐","💥","🔥","💯","🎊","🎉","🎈","🎁","🎀","🎂","🧨",
        "💎","👑","🏆","🥇","🎖️","🏅","🔮","💰","💸","💵","🎯","🚀","⚡","🌪️","🌈","🦄",
        "🌙","☀️","⭐","🌠","💫","✨","🌟","🔥","💥","⚡","🌈","🦋","🌸","💖","💎","👑"
    ],
    "🚀 Virales & Trending": [
        # Emojis que se vuelven virales y tienen animaciones especiales
        "🔥","💯","🚀","💥","⚡","✨","🌟","💫","⭐","🎉","🎊","💎","👑","🏆","🥇","🎯",
        "💖","😍","🤩","😎","🥳","🤯","🤗","😂","🤣","💪","👌","🙌","👏","🔥","💯","🚀",
        "🦄","🌈","🎭","🎪","🎨","🎵","🎶","🎤","🎸","🎹","🎺","🎻","🥁","🎬","🎮","🕹️"
    ],
    "💎 Exclusivos Premium": [
        # Emojis con efectos premium y animaciones únicas
        "💎","👑","🏆","🥇","🎖️","🏅","🔮","💰","💸","💵","💴","💶","💷","🎁","🎀","🎊",
        "🌟","⭐","✨","💫","🌠","🌙","☀️","🌈","🦄","🐉","🦋","🌸","🌺","🌻","🌹","🥀",
        "🎆","🎇","🧨","🎪","🎭","🎨","🎵","🎶","🎤","🎸","🎹","🎺","🎻","🥁","🎬","📸"
    ],
    ...
    "❤️ Amor & Emociones": [
        # Emojis emotivos con animaciones especiales
        "❤️","💕","💞","💓","💗","💖","💘","💝","�","♥️","💋","😍","🥰","😘","🤗","🥺",
        "😭","😢","🥹","😊","☺️","🙂","😌","😉","😚","😙","🤩","🥳","🔥","💯","✨","🌟",
        "�💫","⭐","�","☀️","🌈","🦄","🌸","🌺","🌻","🌹","🥀","💐","🌷","🌼","🌱","🍀"
    ]
...
# Fusionar con los emojis existentes
